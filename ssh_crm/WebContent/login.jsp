        ...
        <TR>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                <TD style="HEIGHT: 18px"><font color="red"><s:property value="exception.message"/></font></TD>
                <TD style="HEIGHT: 18px"></TD>
                <TD style="HEIGHT: 18px"></TD></TR>
              <TR>
                <TD colspan="2">
					<a href="${pageContext.request.contextPath }/register.jsp"><input type="button" value="注册"></a>
					<input type="image" src="images/login_button.gif" onclick="btn()" style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px">
