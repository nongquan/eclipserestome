						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td  >
									<INPUT class=textbox id="visit_time" type="text" 
														style="WIDTH: 180px" maxLength=50 name="visit_time" readonly="readonly" value="<s:property value="#saleVisit.visit_time" />" >
								</td>
							</TR>
							...
							<TR>
								...
								<INPUT class=textbox id="visit_nexttime" readonly="readonly"
														style="WIDTH: 180px" maxLength=50 name="visit_nexttime" value="<s:property value="#saleVisit.visit_nexttime" />">
								</td>
							</TR>
							<tr>
								<td rowspan=2>
