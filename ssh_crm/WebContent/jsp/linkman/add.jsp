...
<html>
<head>
<TITLE><s:property value="#LinkMan!=null?'修改':'添加'"/>联系人</TITLE> 
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人管理 &gt; <s:property value="#LinkMan!=null?'修改':'添加'"/>联系人</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
								<input type="text" style="WIDTH: 180px" id="cust_name" name="customer.cust_name" value="<s:property value='#LinkMan.customer.cust_name'/>"/>
								<!-- 隐藏域 -->
							...
							<TR>
								<td>联系人名称：</td>
								<td>
								<INPUT class=textbox style="WIDTH: 180px" maxLength=50 name="lkm_name" value="<s:property value='#LinkMan.lkm_name'/>">
								</td>
								<td>联系人性别：</td>
								<td> 
